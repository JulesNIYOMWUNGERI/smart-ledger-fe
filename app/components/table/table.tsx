            ...
            <DataTable value={currentPageData} tableStyle={{ minWidth: '20rem' }}>
                {columns.map((col: ColumnType) => (
                    <Column
                        ...
                        bodyClassName={`p-4 bg-[#f6dcab] border-b border-b-[#788286] text-[12px] font-[500] leading-[24px] ${col?.field === 'actions' && 'flex'}`}
                        headerClassName={`bg-[#e5dac6] text-[15px] border-b-4 border-b-[#788286] p-4 text-[#008080] font-semibold ${col?.field === 'actions' && 'flex'}`}
