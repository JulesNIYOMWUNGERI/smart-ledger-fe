...
import emailIcon from "../../../public/login_icon-removebg-preview 2.svg"
import React from 'react'
import Image from 'next/image';
import Button from '@/app/components/Button/Button';
import { FaPhoneSquare, FaRegUserCircle } from "react-icons/fa";
        ...
        <div className='w-1/3 flex flex-col justify-center items-center gap-4 mt-20'>
            ...
            <div className='w-[90%] p-5 bg-[#F6DCAA] flex flex-col justify-center items-center rounded-[10%]'>
                <div className='flex flex-col mb-4'>
                    <h1 className="text-3xl font-bold text-[#636C75]">Login</h1>
                    <div className='w-full h-1 bg-[#FFA500]'></div>
                </div>
                <div className="relative w-full h-[80px] flex flex-col justify-start items-center">
                ...
                <div className='flex w-full mb-4'>
                  <span className='text-[13px] text-[#ffa318]'>forgot password?</span>
                </div>
